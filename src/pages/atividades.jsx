...
export default () => {
    ...
    const coding = (
        <Box>
            <Text mt="12px" textAlign="justify" fontSize="14px">O projeto "Coding: Informática nas Escolas" surgiu com a missão de trazer um ensino de qualidade sobre Programação de Computadores para os jovens de Fortaleza.</Text>
