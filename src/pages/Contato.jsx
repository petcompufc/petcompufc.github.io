...
import { Box, Flex, Input, Stack, Textarea, Heading, Button, ThemeProvider, Text, List, ListItem, ListIcon, theme, Divider, Breadcrumb, Icon, BreadcrumbItem, BreadcrumbLink, FormControl, FormLabel, InputGroup, InputRightElement } from '@chakra-ui/core'
                    ...
                    <Box background='url(https://i1.wp.com/asedpers.org.br/wp-content/uploads/2018/08/gray-texture.jpg?fit=2560%2C1440)'>
                        ...
                        <Box as='form' method='POST' w='100%' h='40%' padding='5%'>
                            <FormControl isRequired>
                                <Stack isInline={window_width > 700} alignItems='center' spacing='28px'>
                                    <Stack>
                                        <InputGroup>
                                ...
                                <Flex marginTop='24px' justifyContent='center'>
                                    <Button type='submit' variantColor='red' boxShadow='2px 2px 3px #000' backgroundImage='url(https://live.staticflickr.com/2329/2240956835_9463c7125b_b.jpg)'
                                        _focus={{outline: 'none'}}
                                        _active={{
